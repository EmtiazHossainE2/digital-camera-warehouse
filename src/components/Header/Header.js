                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className='nav-style my-1'>
                            {user?.uid
                                &&
                                <>
                                    <Nav.Link as={CustomLink} to='/manage-inventories' className='mt-2 fw-bold'>Manage Items</Nav.Link>
                                </>
                            }
                            {user?.uid
                                &&
                            ...
                            {user?.uid
                                ?
                                <NavDropdown className='pt-2 fs-bold text-light '  title="Profile" id="collasible-nav-dropdown">
