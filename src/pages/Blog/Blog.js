    ...
    return (
        <div className='pb-5'>
            ...
            <div className='container'>
                <div>
                    <h4 className='mb-3'>1. Difference between javascript and nodejs ? </h4>
                    <p>JavaScript is a programming language. It is running in any web browser with a proper browser engine.Mainly using for client-side activity for provide some dynamic changes in web pages without refreshing the page.it can run  any engine like Spider monkey , javaScript Core (safari), V8 </p>
                ...
                <div>
                    <h4 className='mb-3'>2.When should you use nodejs and when should you use mongodb ? </h4>
                ...
                <div>
                    <h4 className='mb-3'>3.Differences between sql and nosql databases ? </h4>
