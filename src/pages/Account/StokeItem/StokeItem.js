...
const StokeItem = () => {
    ...
    const handleStoke = event => {
        ...
        if (cameraInfo.name === '' || cameraInfo.price === '' || cameraInfo.description === '' || cameraInfo.img === '' || cameraInfo.quantity === '' || cameraInfo.supplier === '' || cameraInfo.afPoints === '' || cameraInfo.modes === '' || cameraInfo.movieType === '' || cameraInfo.brand === '' || cameraInfo.brandId === '' || cameraInfo.sold === '' || cameraInfo.ratings === '' ) {
                ...
                <Form noValidate onSubmit={handleStoke} >
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} md="3" controlId="validationCustom03">
                            <Form.Control type="text" name='brand' placeholder="Brand" required />
                        </Form.Group>
                        <Form.Group as={Col} md="3" controlId="validationCustom03">
                            <Form.Control type="number" name='sold' placeholder="Sold" required />
                        </Form.Group>
                        <Form.Group as={Col} md="3" controlId="validationCustom03">
                            <Form.Control type="number" name='ratings' placeholder="Ratings" required />
                        </Form.Group>
                        <Form.Group as={Col} md="3" controlId="validationCustom03">
                            <Form.Control type="number" name='brandId' placeholder="Brand Id " required />
                        </Form.Group>
                    </Row>
                    <Row className="mb-3">
                        <Form.Group as={Col} md="6" controlId="validationCustom03">
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} md="6" controlId="validationCustom03">
                            <Form.Control as="textarea" rows={2} type="text" name='afPoints' placeholder="AF Points" required />
                        </Form.Group>
                        <Form.Group as={Col} md="6" controlId="validationCustom03">
                            <Form.Control as="textarea" rows={2} type="text" name='movieType' placeholder="Movie Type" required />
                        </Form.Group>
                    </Row>
                    <Row className="mb-3">
                        <Form.Group as={Col} md="6" controlId="validationCustom03">
                            <Form.Control as="textarea" rows={3} type="text" name='modes' placeholder="Modes" required />
                        </Form.Group>
                        <Form.Group as={Col} md="6" controlId="validationCustom03">
                            <Form.Control as="textarea" rows={3} type="text" name='description' placeholder="Description" required />
                        </Form.Group>
                    </Row>
                    <Button className='bg-success fw-bold mt-3' type="submit">Stoke Now <span className='fs-5 ps-3 '><ImBoxAdd /></span></Button>
                </Form>
            </div>
        </div>
    );
