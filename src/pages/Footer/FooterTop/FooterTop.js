                    ...
                    <div className="row mt-3">
                        <div className="col-md-4 col-sm-6 d-flex justify-content-center">
                            <div className='important-link '>
                                ...
                                <Link to='/instagram'><span className='text-warning pe-2  fs-5'><BsInstagram /></span>Instagram</Link>
                                <Link to='/pinterest'><span className='text-warning pe-2  fs-5'><BsPinterest /></span>Pinterest</Link>
