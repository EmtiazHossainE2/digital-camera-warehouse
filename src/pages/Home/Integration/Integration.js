...
import img2 from '../../../images/section/2.png'
...
const Integration = () => {
    return (
        <div className='container  '>
            <h2 className='text-center text-success text-capitalize fst-italic fw-bold'>What does the Digital Camera Warehouse Integration </h2>
