...
const Business = () => {
    return (
        <div className='container rounded mt-2' style={{ backgroundColor: '#E4E4E4' }}>
            <div className='pt-4'>
                <h2 className='text-center text-success text-capitalize fst-italic fw-bold'>Run a more efficient business. </h2>
                ...
                <div className='col-lg-3 col-md-6 rounded-1 '>
                    <div className=" mx-2 my-4 ">
                        ...
                        <div className='p-3'>
                            ...
                            <p>Expand your business online with our multi-channel inventory management system. Set up and integrate your Amazon, eBay, Etsy, or Shopify account, and start selling your merchandise. </p>
                            <Link to='/' className='text-success'>See More</Link>
                        </div>
                    </div>
                </div>
                <div className='col-lg-3 col-md-6 rounded-1'>
                ...
                <div className='col-lg-3 col-md-6 rounded-1'>
                    <div className=" mx-2 my-4  ">
                        ...
                        <div className='p-3'>
                            ...
                            <p style={{textAlign : 'justify'}}>Manage your offline and online orders with our efficient order management system. Also, you can create purchase orders, backorders and drop shipments, all in a single inventory management application. </p>
                            <Link to='/' className='text-success'>See More</Link>
                        </div>
                    </div>
                </div>
